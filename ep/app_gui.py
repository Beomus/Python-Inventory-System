...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.display_borrowed_laptops.setGeometry(QtCore.QRect(44, 430, 981, 241))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.display_contents = QtWidgets.QWidget()
        self.display_contents.setGeometry(QtCore.QRect(0, 0, 979, 239))
        self.display_contents.setObjectName("display_contents")
        self.display_borrowed_laptops.setWidget(self.display_contents)
        ...
        # status update or output for functions
